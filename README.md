...
<p>This set of Notebooks provides a complete set of code to be able to train and leverage custom object detection model using the Tensorflow Object Detection API.
...
<br/>
<b>Step 4.</b> Collect images using the Notebook <a href="https://github.com/nicknochnack/TFODCourse/blob/main/1.%20Image%20Collection.ipynb">1. Image Collection.ipynb</a> - ensure you change the kernel to the virtual environment as shown below
